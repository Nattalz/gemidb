...
# --- Define MAX_BATCH_SIZE for Gemini ---
# Gemini's embed_content can take a list of texts. While the exact
# maximum batch size can vary, 100-200 documents per API call is a
# common recommendation for stability and avoiding large payloads.
MAX_BATCH_SIZE = 2048    

def get_embedding(documents, key=None, model="text-embedding-004"):
    """Default embedding function that uses Gemini Embeddings."""
    ...
    for batch in batches:
        ...
        embeddings.extend(np.array(item.values)
